...
-- 2023-02-27,CNelson,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_CNelson')
	 Begin 
	  Alter Database [Assignment07DB_CNelson] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_CNelson;
	 End
	Create Database Assignment07DB_CNelson;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_CNelson;
